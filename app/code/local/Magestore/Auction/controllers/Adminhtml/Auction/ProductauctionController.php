...
class Magestore_Auction_Adminhtml_Auction_ProductauctionController extends Mage_Adminhtml_Controller_Action {
	...
	*/
    ...
    public function exportXmlAction() {
	 ...
	 public function exportDepositCsvAction() {
        $fileName = 'deposit.csv';
        $content = $this->getLayout()->createBlock('auction/adminhtml_productauction_edit_tab_listauctiondeposit')
                ->getCsv();

        $this->_sendUploadResponse($fileName, $content);
    }

    public function exportDepositXmlAction() {
